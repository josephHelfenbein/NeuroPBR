...
class ImageProcessorPlugin: NSObject, FlutterPlugin {
    ...
    static func register(with registrar: FlutterPluginRegistrar) {
        ...
        let instance = ImageProcessorPlugin()
    ...
    func handle(_ call: FlutterMethodCall, result: @escaping FlutterResult) {
        switch call.method {
        case "processImage":
            ImageProcessorPlugin.handleProcessImage(call: call, result: result)
        case "processImages":
            ImageProcessorPlugin.handleProcessImages(call: call, result: result)
        default:
